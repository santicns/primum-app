 ...
 * Original file: /home/santiago/workspacejuno/Primum-Android/src/main/java/com/primum/mobile/device/HealthServiceAPI.aidl
 */
package com.primum.mobile.device;
public interface HealthServiceAPI extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.primum.mobile.device.HealthServiceAPI
{
private static final java.lang.String DESCRIPTOR = "com.primum.mobile.device.HealthServiceAPI";
...
/**
 * Cast an IBinder object into an com.primum.mobile.device.HealthServiceAPI interface,
 * generating a proxy if needed.
 */
public static com.primum.mobile.device.HealthServiceAPI asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.primum.mobile.device.HealthServiceAPI))) {
return ((com.primum.mobile.device.HealthServiceAPI)iin);
}
return new com.primum.mobile.device.HealthServiceAPI.Stub.Proxy(obj);
}
...
private static class Proxy implements com.primum.mobile.device.HealthServiceAPI
{
